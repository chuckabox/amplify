...
export default function PassportPage() {
  ...
  return (
    <main id="main" className="mx-auto w-full max-w-[1240px] flex-1 px-6 py-10 md:py-14">
      {justUpdated && (
      ...
      <Reveal>
        <header className="flex flex-col gap-6 border-b border-rule pb-7 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
              <p className="field-label">Living Risk Passport</p>
              <span className="h-3 w-px bg-rule-strong" aria-hidden />
              <span className="font-mono text-[10px] text-ink-faint">
                UPDATED 25 JUL 2026 · 10:42
              </span>
            </div>
            <h1 className="mt-3 text-[clamp(2.6rem,6vw,4.6rem)] font-semibold leading-[0.95] text-ink">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link href="/visual-evidence">
              <Button variant="outline">Visual evidence</Button>
            </Link>
            <Link href="/audit">
      ...
      <nav
        aria-label="Risk Passport sections"
        className="mt-6 flex gap-1 overflow-x-auto border-b border-rule"
      >
        {VIEWS.map((item) => (
          <button
            key={item.id}
...
function Overview({ setView }: { setView: (view: View) => void }) {
  ...
  return (
    <>
      <Reveal delay={0.06}>
        <section className="mt-8 grid gap-px overflow-hidden rounded-[4px] border border-rule bg-rule lg:grid-cols-[1.25fr_repeat(4,0.7fr)]">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1.12fr_0.88fr]">
        ...
        <Reveal delay={0.14}>
          <section aria-labelledby="critical-heading">
            ...
            <div className="mt-5 overflow-hidden rounded-[4px] border border-tier-3-ink bg-paper-raised">
      ...
      <Reveal>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 id="entities-heading" className="mt-2 text-3xl font-semibold text-ink">
...
function ControlsView() {
  return (
    <section className="mt-8" aria-labelledby="controls-heading">
      <Reveal>
        <div className="grid gap-5 lg:grid-cols-[1fr_0.55fr] lg:items-end">
          <div>
            <p className="field-label">Evidence-to-control mapping</p>
            <h2 id="controls-heading" className="mt-2 text-3xl font-semibold text-ink">
...
function DocumentsView() {
  return (
    <section className="mt-8" aria-labelledby="documents-heading">
      <Reveal>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 id="documents-heading" className="mt-2 text-3xl font-semibold text-ink">
              Source documents
            </h2>
          </div>
          <Link href="/audit">
      ...
      <Reveal delay={0.08}>
        <div className="mt-8 overflow-x-auto rounded-[4px] border border-rule bg-paper-raised">
...
function EntityCard({ entity }: { entity: PassportEntity }) {
  return (
    <article className="overflow-hidden rounded-[4px] border border-rule bg-paper-raised">
